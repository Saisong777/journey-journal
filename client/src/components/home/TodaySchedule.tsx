        ...
        <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto">
          ...
          {selectedAttraction && (
            selectedAttraction.mdContent ? (
              <div className="prose prose-sm max-w-none prose-headings:text-primary prose-h2:text-base prose-h2:mt-4 prose-h2:mb-2 prose-h3:text-sm prose-p:text-foreground prose-p:leading-relaxed prose-blockquote:border-primary/30 prose-blockquote:text-muted-foreground prose-li:text-foreground prose-strong:text-foreground">
